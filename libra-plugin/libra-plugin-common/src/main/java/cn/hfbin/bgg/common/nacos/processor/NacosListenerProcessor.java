...
package cn.hfbin.bgg.common.nacos.processor;

import cn.hfbin.bgg.common.constant.CommonConstant;
import cn.hfbin.bgg.common.entity.NacosFormatType;
import cn.hfbin.bgg.common.nacos.operation.NacosOperation;
import cn.hfbin.bgg.common.processor.AbstractConfigProcessor;
import cn.hfbin.bgg.common.thread.ThreadPoolFactory;
...
public abstract class NacosListenerProcessor extends AbstractConfigProcessor {
    ...
    public void initialize() {
        ...
        try {
            ...
            e.printStackTrace();
            log.error("add nacos listener error");
        }
        try {
