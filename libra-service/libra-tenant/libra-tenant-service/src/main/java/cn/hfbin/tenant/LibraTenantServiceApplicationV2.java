...
public class LibraTenantServiceApplicationV2 {

	public static void main(String[] args) {
		System.setProperty("server.port", "7825");
		System.setProperty("spring.cloud.nacos.discovery.metadata.version", "3.0");

		SpringApplication.run(LibraTenantServiceApplicationV2.class, args);
	}
