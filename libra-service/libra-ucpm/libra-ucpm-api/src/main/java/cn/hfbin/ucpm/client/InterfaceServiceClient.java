...
/**
 * @Author: huangfubin
 * @Description: 接口表 服务调用接口及熔断处理
 * @Date: 2021-06-18
 */
@FeignClient(name = UcPmConstant.UCPM_SERVICE_NAME, path = UcPmConstant.UCPM_PATH + "/interface")
public interface InterfaceServiceClient extends InterfaceApiService {
